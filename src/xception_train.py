...
BATCH_SIZE = 16
LEARNING_RATE = 3e-5  # More stable for pretrained models
EPOCHS = 10
IMAGE_SIZE = 299
VALIDATION_SPLIT = 0.1

MODEL_SAVE_PATH = os.path.join(SAVE_DIR, "xception_best.pth")
LOSS_PLOT_PATH = os.path.join(SAVE_DIR, "xception_train_loss.png")
ACC_PLOT_PATH = os.path.join(SAVE_DIR, "xception_val_accuracy.png")
